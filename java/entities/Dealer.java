...
public class Dealer {
  ...
  /**
   * Dealer constructor
   * @param data contains relevant attributes for Dealer class
   */
  ...
  /**
   * Populates a table for the Dealer class
  ...
  /**
   * Creates SQL statement to do a bulk add of Dealer entities
   * @param arr list of entities
   */
  private static String createInsertEntitiesSQL(ArrayList<Dealer> arr) {
     ...
     */
    sb.append("INSERT INTO dealer (ID, NAME, STREET, COUNTY, STATE, ZIP) VALUES");
